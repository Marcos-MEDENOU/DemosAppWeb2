...
<%--  	 <c:forEach items="${metier}" var="i"> --%>
<%--  		<p>Un message n <c:out value="${i}"></c:out></p> --%>
<%--  	</c:forEach> --%>
 	
 	<%-- <c:forEach items="${metier}" var="i" begin="0" end="10" step="1">
 		<p>Un message n <c:out value="${i}"></c:out></p>
 	</c:forEach> --%>
 	
<%--  	<c:if test="${!empty completName}"> --%>
<!--  		<p> -->
<%--  			<c:out value="Welcome ${completName}"></c:out> --%>
<!--  		</p> -->
<%--  	</c:if> --%>

<%-- 	<c:if test="${!empty response.resultat}"> --%>
<!--  		<p> -->
<%--  			<c:out value=" ${response.resultat}"></c:out> --%>
<!--  		</p> -->
<%--  	</c:if> --%>
